...
public class TestUtils {
    ...
    public static boolean entityInPosition(List<EntityResponse> entities, String type, Position position) {
        return entities.stream().anyMatch(e -> e.getType().startsWith(type) && e.getPosition().equals(position));
    }
